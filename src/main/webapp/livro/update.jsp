...
<html> <!-- INICIA O DOCUMENTO HTML -->
    ...
    <body> <!-- INICIA A TAG BODY (DEFINE O CORPO DO DOCUMENTO, O QUE É VÍSIVEL AO USUÁRIO) -->
        ...
        <main class="container"> <!-- INICIA A TAG MAIN (CONTEÚDO PRINCIPAL DO DOCUMENTO) -->
            ...
            <form action="/livro/update" method="post"> <!-- INCIA O FORMULÁRIO QUE ENVIA DADOS PARA livro/update ATRAVÉS DO MÉTODO POST (DADOS ANEXADOS NO CORPO DA MENSAGEM, OU SEJA, NÃO APARECEM NA URL) -->
                ...
                <a href="/livro/list" class="btn btn-danger">Voltar</a> <!-- EXIBE UM ÂNCORA ESTILIZADA COM BOOTSTRAP PARA VOLTAR A PÁGINA -->
